...
namespace API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.RegisterAssemblyPublicNonGenericClasses(typeof(TreasureHuntServices).Assembly)
                        .Where(x => x.Name.EndsWith("Services"))
                        .AsPublicImplementedInterfaces(ServiceLifetime.Singleton);

            //ServiceLifetime defaults to Transient lifetime
            services.RegisterAssemblyPublicNonGenericClasses(typeof(TreasureHuntBS).Assembly)
            ...
            services.AddSwaggerGen(options =>
            {
                ...
                {
                    Title = "AWING_TEST_API API",
                    Version = "v1",
                    Description = "Document AWING_TEST_API API",
                });
            });
        }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwagger();
            app.UseSwaggerUI(options => options.SwaggerEndpoint("/swagger/v1/swagger.json", "AWING_TEST_API"));
        }
    }
}
