import UilMap from '@iconscout/react-unicons/dist/icons/uil-map';
...
const MenuItems: FC<IMenuItems> = ({ toggleCollapsed }) => {
  ...
  const items = [
    getItem(
      <NavLink onClick={toggleCollapsed} to={`${path}/treasureHunt`}>
        Tìm kho báu
      </NavLink>,
      'treasureHunt',
      undefined,
      <NavLink className="menuItem-icon" to={`${path}/treasureHunt`}>
        <UilMap />
      </NavLink>,
    ),
  ];
